...
CFLAGS = -m32 -Wall $(LIB) -c -fno-builtin
...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o \
	   ...
	   $(BUILD_DIR)/keyboard.o $(BUILD_DIR)/tss.o
...
$(BUILD_DIR)/memory.o: kernel/memory.c kernel/memory.h \
        lib/stdint.h lib/kernel/bitmap.h lib/kernel/print.h \
		kernel/global.h kernel/global.h kernel/debug.h lib/stdint.h \
		lib/kernel/io.h kernel/interrupt.h lib/string.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/sync.o: thread/sync.c thread/sync.h \
        lib/kernel/list.h kernel/global.h lib/stdint.h kernel/debug.h \
		thread/thread.h lib/string.h   kernel/interrupt.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/console.o: device/console.c device/console.h \
        lib/stdint.h lib/kernel/print.h thread/sync.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/tss.o: userprog/tss.c userprog/tss.h \
        lib/stdint.h kernel/global.h lib/string.h lib/kernel/print.h
	$(CC) $(CFLAGS) $< -o $@
...
hd:
    ...
    of=/home/amdin/os/bochs-2.6.2/hd60M.img \
